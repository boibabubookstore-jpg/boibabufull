        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">BoiBabu</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/books?featured=true" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Featured Books
                </Link>
              </li>
              <li>
                <Link to="/books?bestseller=true" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Bestsellers
                </Link>
              </li>
              <li>
                <Link to="/books?newArrival=true" className="text-gray-300 hover:text-primary-400 transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link to="/seller/register" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Join as Seller in BoiBabu
                </Link>
              </li>
            </ul>
          </div>
